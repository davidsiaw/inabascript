...
public class Scanner {
	...
	public List<List<Token>> lines = new List<List<Token>>();	// Lines of tokens
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 6:
				if (ch == 187) {AddCh(); goto case 7;}
				else {goto case 0;}
			case 7:
				if (ch == 191) {AddCh(); goto case 8;}
				else {goto case 0;}
			case 8:
				{t.kind = 5; break;}
			case 9:
				if (ch == '!' || ch >= '#' && ch <= '$' || ch == '&' || ch >= '(' && ch <= '[' || ch >= ']' && ch <= '_' || ch >= 'a' && ch <= '~' || ch == 65379 || ch == 65385 || ch == 65390) {AddCh(); goto case 9;}
				else if (ch == '"') {AddCh(); goto case 11;}
				else if (ch == 92) {AddCh(); goto case 10;}
				else {goto case 0;}
			case 10:
				if (ch == 92 || ch == 'n' || ch == 'r') {AddCh(); goto case 9;}
				else {goto case 0;}
			case 11:
				{t.kind = 6; break;}
			case 12:
